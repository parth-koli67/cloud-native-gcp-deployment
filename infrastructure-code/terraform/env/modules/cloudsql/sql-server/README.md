...
| <a name="requirement_google"></a> [google](#requirement\_google) | >= 5.25, < 6 |
| <a name="requirement_google-beta"></a> [google-beta](#requirement\_google-beta) | >= 5.25, < 6 |
...
| Name | Version |
|------|---------|
| <a name="provider_google"></a> [google](#provider\_google) | >= 5.25, < 6 |
| <a name="provider_google-beta"></a> [google-beta](#provider\_google-beta) | >= 5.25, < 6 |
...
| <a name="input_zone"></a> [zone](#input\_zone) | The zone for the master instance, it should be something like: `us-central1-a`, `us-central1-c`. | `string` | n/a | yes |

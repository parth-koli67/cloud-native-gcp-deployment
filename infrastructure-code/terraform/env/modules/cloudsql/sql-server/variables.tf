...
variable "secondary_zone" {
  type        = string
  description = "The preferred zone for the read replica instance, it should be something like: `us-central1-a`, `us-central1-c`."
  default     = null
}
...
variable "database_name" {
  description = "The name of the custom database to be created"
  type        = string
  default     = ""  # Default is empty, meaning no custom database is created unless specified
}
